...
DEFAULT_USER_AGENT = "GhostMap/%s (+https://github.com/yoshikatasergio/)" % '.'.join(VERSION.split('.')[:3])
...
# colorful banner (GhostMap / Yoshi Edition)
# Based on sqlmap by Bernardo Damele Assumpcao Guimaraes & Miroslav Stampar
# Original work: https://sqlmap.org  (GPLv2)
import platform as _platform
import sys as _sys

_py_ver = "%d.%d.%d" % _sys.version_info[:3]
_os_label = "%s %s" % (_platform.system(), _platform.machine())
...
\\____/_/ /_/\\____/____/\\__/_/  /_/\\__,_/ .___/
                                      /_/
\033[0m\033[01;37m       Adaptive SQL Injection & Database Audit Framework\033[0m
\033[01;30m       Yoshi Edition  ·  v%s  ·  modified by Sergio Yoshikata Mifflin\033[0m

\033[01;30m  +%s+\033[0m
\033[01;30m  | \033[01;37mruntime    \033[0mpython %s  ·  %s%s\033[01;30m |\033[0m
\033[01;30m  | \033[01;37mauthor     \033[0mSergio Yoshikata Mifflin <yoshikatasergio@gmail.com>%s\033[01;30m |\033[0m
\033[01;30m  | \033[01;37mbasis      \033[0msqlmap %s (GPLv2)%s\033[01;30m |\033[0m
\033[01;30m  | \033[01;37mhomepage   \033[0mhttps://github.com/yoshikatasergio/%s\033[01;30m |\033[0m
\033[01;30m  +%s+\033[0m
""" % (
    '.'.join(VERSION.split('.')[:3]),
    "-" * 70,
    _py_ver, _os_label, " " * max(0, 70 - 16 - len(_py_ver) - len(_os_label) - 7),
    " " * max(0, 70 - 16 - 41),
    VERSION_STRING.split('/')[-1], " " * max(0, 70 - 16 - len(VERSION_STRING.split('/')[-1]) - 8),
    " " * max(0, 70 - 16 - 35),
    "-" * 70,
)
...
# Note: prior sqlmap banner had animated [.] characters; GhostMap banner does not use them.
